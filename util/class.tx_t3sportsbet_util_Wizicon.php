...
class tx_t3sportsbet_util_Wizicon extends tx_rnbase_util_Wizicon
{
    ...
    {
        $plugins = [];
        $plugins['tx_t3sportsbet_main'] = [
            'icon' => tx_rnbase_util_Extensions::extRelPath('t3sportsbet') . '/ext_icon.gif',
    ...
    {
        return tx_rnbase_util_Extensions::extPath('t3sportsbet') . 'locallang_db.xml';
    }
}
